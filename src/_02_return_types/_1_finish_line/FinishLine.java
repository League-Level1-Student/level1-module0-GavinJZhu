...
public class FinishLine {
    ...
    public static void main(String[] args) {
        ...
        if (hasCrossedFinishLine()) {
            ...
            JOptionPane.showMessageDialog(null, "The robot finished! The robot moved " + distance + " pixels!");

        }
        //7. Else use a pop up to say the robot did not finish and how far it went
			else{
				JOptionPane.showMessageDialog(null, "Oof! The robot didn't finish. The robot still went "+ distance+ " pixels though!");
		}
    }
